...
public class Locations_impl implements Locations {

	private LocationEnum locationValue;

	public Locations_impl() {
	    locationValue = LocationEnum.UNKNOWN;
	}
	
	private static final Log LOG = LogFactory.getLog(Locations_impl.class);
	...
	public SelectItem[] getLocations() {
	    ...
	    return new Locations_impl().getLocationSelectItems(resourceManager, "webapp");
	}
